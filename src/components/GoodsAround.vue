<template>
  <div class="around-container">
    <div class="goods-top">
      <goods-top :top-title="topTitle" :subs="subs"></goods-top>
    </div>
...
<script>
  import GoodsTop from './common/GoodsTop.vue'
  import GoodsLeft from './common/GoodsLeft.vue'
  import GoodsRight from './common/GoodsRight.vue'
  export default({
    data () {
      return {
        topTitle: '周边',
