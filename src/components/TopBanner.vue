  ...
  <div class="top-banner clearfix">
    <div class="site-category"@mouseleave="evtSideLeave">
      <div class="top-side-left">
        <ul>
          <li v-for="item in sideItems" @mouseenter="evtSideEnter(item.type)">
            {{item.content}}
          </li>
        </ul>
      </div>
      <div class="site-category-detail" 	v-show="goodsStatus">
          <ul v-for="goods in filterCurrGoods">
            <li v-for="item in goods">
              ...
              <a class="goods-buy-link" :href="item.buyUrl" v-show="item.buyStatus">
                选购
              </a>
            </li>
          </ul>
...
<style scoped="">
  ...
  .site-category .top-side-left ul{
    width:235px;
    height:420px;
  }
  .site-category .top-side-left  ul li{
    width:100%;
    height:42px;
    line-height:42px;
    font-size:14px;
  ...
  .site-category .top-side-left ul li:hover{
    background:#ff6700;
  }
  ...
  .site-category-detail ul {
    width: auto;
    height: 460px;
    background: #fff;
  }
  .site-category-detail ul li{
    display: flex;
    flex-flow: row nowrap;
    justify-content: flex-start;
    align-items: center;
  ...
  .site-category-detail ul li a.goods-link{
    display: flex;
    flex-flow: row nowrap;
    justify-content: flex-start;
    align-items: center;
  ...
  .site-category-detail ul li a.goods-link div{
    padding-left:10px;
    font-size:14px;
  }
  .site-category-detail ul li a.goods-buy-link{
    display: block;
    width:58px;
    height:22px;
    line-height:24px;
  ...
  .site-category-detail ul li a.goods-buy-link:hover{
    color:#fff;
    background:#ff6700;
  }
</style>
<script>
  ...
  export default({
    ...
    methods:{
      evtSideEnter:function (currType) {
